#
# Module manifest for module 'FabricACEToolkit'
#
# Generated by: FabricACEToolkit
#
...
RootModule = 'FabricACEToolkit.psm1'
...
Author = 'FabricACEToolkit'

# Company or vendor of this module
CompanyName = 'FabricACEToolkit'

# Copyright statement for this module
Copyright = '2024 FabricACEToolkit by Tiago Balabuch'

# Description of the functionality provided by this module
Description = 'FabricACEToolkit'
...
FunctionsToExport = 'Set-FabricHeaders', 'Get-FabricCapacity', 'Get-FabricDashboard', 
               'Get-FabricDataPipeline', 'New-FabricDataPipeline', 
               'Remove-FabricDataPipelines', 'Update-FabricNotebook', 
               ...
               'Get-FabricEventstreamDefinition', 'New-FabricEventstream', 
               'Remove-FabricEventstream', 'Update-FabricEventstream', 
               'Update-FabricEventstreamDefinition', 'Get-FabricKQLDashboard', 
               ...
               'Update-FabricKQLQuerysetDefinition', 'Get-FabricLakehouse', 
               'Get-FabricLakehouseTable', 'Load-FabricLakehouseTable', 
               'New-FabricLakehouse', 'Remove-FabricLakehouse', 
               'Start-FabricLakehouseTableMaintenance', 'Update-FabricLakehouse', 
               'Get-FabricMLExperiment', 'New-FabricMLExperiment', 
               'Remove-FabricMLExperiment', 'Update-FabricMLExperiment', 
               'Get-FabricMLModel', 'New-FabricMLModel', 'Remove-FabricMLModel', 
               'Update-FabricMLModel', 'Get-FabricNotebook', 
               'Get-FabricNotebookDefinition', 'New-FabricNotebook', 
               'New-FabricNotebookNEW', 'Remove-FabricNotebook', 
               'Update-FabricNotebook', 'Update-FabricNotebookDefinition', 
               'Get-FabricPaginatedReport', 'Update-FabricPaginatedReport', 
               'Get-FabricReflex', 'Get-FabricReflexDefinition', 'New-FabricReflex', 
               ...
               'Update-FabricReportDefinition', 'Get-FabricSparkCustomPool', 
               'Get-FabricSparkSettings', 'New-FabricSparkCustomPool', 
               'Remove-FabricSparkCustomPool', 'Update-FabricSparkCustomPool', 
               'Update-FabricSparkSettings', 'Get-FabricSQLEndpoint', 
               'Get-FabricTenantSetting', 
               'Get-FabricTenantSettingOverridesCapacity', 'Get-FabricWarehouse', 
               'New-FabricWarehouse', 'Remove-FabricWarehouse', 
               'Update-FabricWarehouse', 'Add-FabricWorkspaceIdentity', 
