...
.DESCRIPTION
The `Set-FabricWorkspaceCapacity` function sends a POST request to assign a workspace to a specific capacity.
...
.EXAMPLE
Set-FabricWorkspaceCapacity -WorkspaceId "workspace123" -CapacityId "capacity456"
