...
function New-FabricKQLDatabase {
    ...
    try {
        Write-Message -Message "Description: '$KQLDatabaseDescription'" 
        Write-Message -Message "KQLInvitationToken: '$KQLInvitationToken'" 
        ...
        if ($KQLDatabasePathDefinition) {
            $KQLDatabaseEncodedContent = Encode-ToBase64 -filePath $KQLDatabasePathDefinition
            ...
            if ($KQLDatabasePathPlatformDefinition) {
                $KQLDatabaseEncodedPlatformContent = Encode-ToBase64 -filePath $KQLDatabasePathPlatformDefinition
            ...
            if ($KQLDatabasePathSchemaDefinition) {
                $KQLDatabaseEncodedSchemaContent = Encode-ToBase64 -filePath $KQLDatabasePathSchemaDefinition
