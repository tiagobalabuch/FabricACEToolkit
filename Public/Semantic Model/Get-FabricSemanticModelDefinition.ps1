...
.EXAMPLE
    PS C:\> Get-FabricSemanticModelDefinition -WorkspaceId "workspace-12345" -SemanticModelId "SemanticModel-67890"
...
.EXAMPLE
    PS C:\> Get-FabricSemanticModelDefinition -WorkspaceId "workspace-12345" -SemanticModelId "SemanticModel-67890" -SemanticModelFormat "json"
    ...
    try {
        ...
        switch ($statusCode) {
            ...
            202 {
                ...
                Write-Message -Message "Getting SemanticModel '$SemanticModelId' definition request accepted. Retrieving in progress!" -Level Debug
