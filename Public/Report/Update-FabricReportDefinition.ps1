...
.PARAMETER ReportPathDefinition
    An optional path to the Report definition file to upload.

.PARAMETER ReportPathPlatformDefinition
    An optional path to the platform-specific definition file to upload.

.EXAMPLE
    PS C:\> Update-FabricReportDefinition -WorkspaceId "workspace-12345" -ReportId "Report-67890" -ReportPathDefinition "C:\Path\To\ReportDefinition.json"
