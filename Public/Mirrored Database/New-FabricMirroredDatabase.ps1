...
An optional path to the MirroredDatabase definition file (e.g., .ipynb file) to upload.
...
.EXAMPLE
 Add-FabricMirroredDatabase -WorkspaceId "workspace-12345" -MirroredDatabaseName "New MirroredDatabase" -MirroredDatabasePathDefinition "C:\MirroredDatabases\example.ipynb"
